  ...
  .onDocumentUpdated("workouts/{workout_id}/activities/{activity_id}",
    async (event) => {
      try {
        ...
        const previousNumSets = previousData.activity_sets.length;
        const numActivitySetsDifference = currentNumSets - previousNumSets;
  ...
  .onDocumentUpdated("workouts/{workout_id}/activities/{activity_id}",
    async (event) => {
      try {
        ...
        // user/{user_id}/workout_insights/{insight_id}.total_sets
        insightSnapshot.forEach((doc) => {
          let updatePromise: Promise<admin.firestore.WriteResult>;
          const currentInsight = doc.data() as WorkoutInsight;
          let insightUpdates: ResistanceSet | RunSet | SwimSet;
          const error = new SyntaxError(
            "Modified Set has malformed set_type: Invalid Set Type."
          );
          ...
          case "resistance_set":
            ...
            updatePromise = doc.ref.update({
              "total_weight":
              FieldValue.increment(insightUpdates.weight),
              "highest_weight_value":
              currentInsight.highest_weight_value,
              "highest_weight_set_index":
              currentInsight.highest_weight_set_index,
              "activity_id_most_weight":
              currentInsight.activity_id_most_weight,
              "total_repetitions":
              FieldValue.increment(insightUpdates.repetitions),
              "highest_repetitions_value":
              currentInsight.highest_repetitions_value,
              "highest_repetitions_set_index":
              currentInsight.highest_repetitions_set_index,
          ...
          case "run_set":
            ...
            updatePromise = doc.ref.update({
              "total_run_distance":
              FieldValue.increment(insightUpdates.distance),
              "highest_run_distance_value":
              currentInsight.highest_run_distance_value,
              "highest_run_distance_set_index":
              currentInsight.highest_run_distance_set_index,
              "activity_id_most_run_distance":
              currentInsight.activity_id_most_run_distance,
              "total_elevation":
              FieldValue.increment(insightUpdates.elevation),
              "highest_elevation_value":
              currentInsight.highest_elevation_value,
              "highest_elevation_set_index":
              currentInsight.highest_elevation_set_index,
              "activity_id_most_elevation":
              currentInsight.activity_id_most_elevation,
              "total_run_duration":
              FieldValue.increment(insightUpdates.duration),
              "highest_run_duration_value":
              currentInsight.highest_run_duration_value,
              "highest_run_duration_set_index":
              currentInsight.highest_run_duration_set_index,
          ...
          case "swim_set":
            ...
            updatePromise = doc.ref.update({
              "total_swim_distance":
              FieldValue.increment(insightUpdates.distance),
              "highest_swim_distance_value":
              currentInsight.highest_swim_distance_value,
              "highest_swim_distance_set_index":
              currentInsight.highest_swim_distance_set_index,
              "activity_id_most_swim_distance":
              currentInsight.activity_id_most_swim_distance,
              "total_laps":
              FieldValue.increment(insightUpdates.laps),
              "highest_laps_value":
              currentInsight.highest_laps_value,
              "highest_laps_set_index":
              currentInsight.highest_laps_set_index,
              "activity_id_most_laps":
              currentInsight.activity_id_most_laps,
              "total_swim_duration":
              FieldValue.increment(insightUpdates.duration),
              "highest_swim_duration_value":
              currentInsight.highest_swim_duration_value,
              "highest_swim_duration_set_index":
              currentInsight.highest_swim_duration_set_index,
